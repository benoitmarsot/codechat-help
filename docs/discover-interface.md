...
![Discover main screen, numbered 1 through 7](images/discover/main-screen.png)
...
![User control panel with Light/Dark toggle, Admin, Profile, and Log out options](images/discover/user-controls.png)
...
![Discussion list with the three-dot menu open, showing Auto-catalog, Rename & describe, Add to favorites, Export as PDF, and Delete](images/discover/left-menu-options.png)
