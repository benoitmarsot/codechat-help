...
3. Suggested actions can also include a call to **LiquidAmber Engage**, which creates a shareable graphic and links out to the embedded Q&A widget on the publisher's site. See [Engage](engage.md).
4. If photos are associated with the original stories, they're displayed in the response. Each image can be downloaded for re-use or reference.
